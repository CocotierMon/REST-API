package com.crud.tasks_api.trello.client;
...
import com.crud.tasks_api.trello.config.TrelloConfig;
...
public class TrelloClient {
    ...
    public List<TrelloBoardDto> getTrelloBoards() {
        ...
        URI url = UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint() + "/members/monikawalewska/boards")
